...
{
    if(log_line && log_file) os << file << ":" << line << " " << message << "\n";
    else if (log_line) os << "Line " << line << " " << message << "\n";
    else if (log_file) os << file << " " << message << "\n";
    else os <<  message << "\n";

}

#define LOG(logger, message) logger.SetFile(__FILE__); \
